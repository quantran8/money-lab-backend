...
export class LearnService {
    ...
    async updateProgress(userId: string, lessonId: number, status: string, score?: number) {
        ...
        if (score !== undefined) {
            ...
            if (!currentProgress || (currentProgress.bestScore === null || score > currentProgress.bestScore)) {
